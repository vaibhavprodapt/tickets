...
def get_tsg_functional_response(buisness_use_case, system_name):
    ui_response = openai.Completion.create(
        model="text-davinci-003",
        prompt=f"Statement:\n\"{buisness_use_case}\"\n{system_name}\nwhat all things are mandatory to be part of buisness story from this use case in User interface (UI) test cases:\n(give answer in 5 numbered points in new line)\n\nAnswer:",
        temperature=1,
        max_tokens=300,
        top_p=1,
    ...
    usability_response = openai.Completion.create(
        model="text-davinci-003",
    ...
    functionality_response = openai.Completion.create(
        model="text-davinci-003",
    ...
    ui_response = ui_response.choices[0].text
    ui_response= ui_response.strip()

    usability_response = usability_response.choices[0].text
    usability_response = usability_response.strip()

    functionality_response = functionality_response.choices[0].text
    functionality_response = functionality_response.strip()

    integration_response = integration_response.choices[0].text
    integration_response = integration_response.strip()

    return f"User interface (UI) test cases:\n{ui_response}", f"Usability test cases:\n{usability_response}", f"Functionality test cases:\n{functionality_response}", f"Integration test cases:\n{integration_response}"
...
# ##Ticket Status Insight And Functionality
# tsi_generator_layout = html.Div([
#     dbc.Navbar(children=[
#         dbc.NavItem(html.A(html.I(className="fas fa-home"), href="/", style={"margin": "0px 0px 0px 20px", "font-size": "30px", "color": "white"})),
#         dbc.NavbarBrand("Ticket Status Insight", className="mx-auto",
#                         style={"text-align": "center", "font-size": "35px", "font-weight": "bold"}),
#         dbc.NavItem("Synapt-GDK", style={"margin-right": "20px", "color": "red", "font-weight": "bold"})], color="dark",
#                    dark=True),
#     dbc.Row([
#         dbc.Col([
#             html.H3("Text Paste Here:", style={'font-size': '30px'}),
#             dbc.Textarea(id='tsg-input', placeholder='Type or Paste Buisness case here...',
#                          style={'height': '150px', 'resize': 'none', 'background-color': '#444444', 'color': 'white'})
#         ], width=6),
#         dbc.Col([
#             html.H3("Upload PDF File Here:", style={'font-size': '30px'}),
#             dcc.Upload(
#                 id='upload-data',
#                 children=html.Button('Upload PDF'),
#                 multiple=False,
#                 style={'height': '150px', 'resize': 'none', 'background-color': '#444444', 'color': 'white'}
#             )
#         ], width=5),
#         dbc.Col([
#             dbc.Button([html.I(' Submit', className='fas fa-paper-plane')], color='primary', id="tsg-submit",
#                        style={'justify-content': 'center', 'width': '120px', 'margin': '47px 0px 0px 0px'}),
#             dbc.Button([html.I(' Download', className='fas fa-download')], color="primary", href="", download="example.docx",
#                        target="_blank", style={'justify-content': 'center', 'width': '120px', 'margin': '16px 0px 0px 0px'},
#                        id="tsg-save"),
#             dbc.Button([html.I(' Email', className='fas fa-envelope')], color="success",
#                        style={'justify-content': 'center', 'width': '120px', 'margin': '16px 0px 0px 0px'}, id="tsg-email"),
#         ], className='d-flex flex-column align-items-center')
#     ], style={'margin': '20px 0px'}),
#     dcc.Loading(id='tsi-loading', children=[
#         html.Div(id='tsi-loading-output'),
#     ], type='circle', fullscreen=False),
#     dbc.Row([
#         dbc.Alert("Failed to send Email. Check your password and try again", id="tsg-email-failed", color="danger",
#                   dismissable=True, is_open=False, className="mt-3")
#     ]),
#     dbc.Row([
#         dbc.Alert("Email sent successfully", id="tsg-email-success", color="success", dismissable=True, is_open=False,
#                   className="mt-3")
#     ]),
#     dbc.Row([
#         dbc.Col([
#             html.H3("Email Message", style={'font-size': '30px'}),
#             dbc.Textarea(id='ts-Sms-box', placeholder='Nothing generated yet...',
#                          style={'height': '500px', 'resize': 'none', 'word-wrap': 'break-word',
#                                 'overflow-wrap': 'break-word', 'background-color': '#444444', 'color': 'white'},
#                          readOnly=True)
#         ], width=6),
#         dbc.Col([
#             html.H3("SMS Message", style={'font-size': '30px'}),
#             dbc.Textarea(id='ts-Email-functional-box', placeholder='Nothing generated yet...',
#                          style={'height': '500px', 'resize': 'none', 'word-wrap': 'break-word',
#                                 'overflow-wrap': 'break-word', 'background-color': '#444444', 'color': 'white'},
#                          readOnly=True)
#         ], width=6),
...
#     # Assuming uploaded_pdf is the contents of the uploaded PDF file

#     # Check if PDF file is provided
#     if uploaded_pdf is None:
#         raise ValueError("No PDF file provided.")

#     # Convert the contents to a readable PDF file
...
# # Define your SMS generation function
# def generate_sms():
#     # Add your SMS generation logic here
#     customer_name = "[Customer's Name]"
#     your_name = "[Your Name]"
#     your_company = "[Your Company]"  # Add this line to define your_company
#     ticket_number = "[Ticket Number]"
#     progress_update = "[Brief progress update]"
#     current_status = "[Current status]"
#     next_steps = "[Outline any upcoming actions]"

#     # Define a chain of thought based on the trimmed extracted text
#     chain_of_thought_prompts = [
#         f"Hi {customer_name}! This is {your_name} from {your_company}. Quick update on your ticket {ticket_number}:",
#         f"Progress: {progress_update}",
#         f"Status: {current_status}",
#         f"Next Steps: {next_steps}",
#         "Thanks for your patience! Feel free to reply if you have questions.",
#         f"Best, {your_name}@[YourCompany]"
#     ]

#     # Print the input to GPT-3
#     print("\n".join(chain_of_thought_prompts))

#     # Generate the SMS-like message using the chain of thought prompts
#     response = openai.Completion.create(
#         engine="text-davinci-003",
#         prompt="\n".join(chain_of_thought_prompts),
#         temperature=0.7,
...
#     # Extract and print the generated SMS-like message
#     generated_sms = response.choices[0].text.strip()

#     # Replace placeholders with actual values
#     generated_sms = generated_sms.replace(customer_name, "Actual Customer's Name")
#     generated_sms = generated_sms.replace(your_name, "Your Actual Name")
#     generated_sms = generated_sms.replace(ticket_number, "Actual Ticket Number")
#     generated_sms = generated_sms.replace(progress_update, "Actual Progress Update")
#     generated_sms = generated_sms.replace(current_status, "Actual Current Status")
#     generated_sms = generated_sms.replace(next_steps, "Actual Next Steps")

#     # Use the provided trimmed_pdf_text and any other necessary information
#     return generated_sms

# # Define your Email generation function
# def generate_email():
...
#     # Define a chain of thought based on the trimmed extracted text
#     chain_of_thought_prompts = [
#         f"Subject: Update on Your Ticket - {ticket_number} and Issue",
#         f"\nDear {customer_name},",
#         f"\nI hope this message finds you well. I'm writing to provide you with an update on the status of your ticket.",
#         f"\nProgress:",
#         f"\n1. Resolution status: We have made significant progress in resolving the issue you reported. Our team has identified the root cause and is currently working on implementing a solution.",
#         f"\n2. Current Work queue: Your ticket is currently in the top priority position in our work queue. Our technicians are dedicated to resolving your issue as soon as possible.",
#         f"\n3.Actions Taken: To date, we have successfully investigated the problem, conducted thorough diagnostics, and implemented temporary measures to minimize the impact on your services. Our team has been working diligently to find a permanent resolution.",
#         f"\n4.Next Steps: We plan to provide another update on {date}. In the meantime, if you have any additional information or questions, please feel free to respond to this email. Our team is actively monitoring the ticket and will be happy to assist you.",
...
#     # Generate the email-like message using the chain of thought prompts
#     response = openai.Completion.create(
#         engine="text-davinci-003",
#         prompt="\n".join(chain_of_thought_prompts),
#         temperature=0.7,
#         max_tokens=3500  # Adjust this value as needed
#     )

#     # Extract and print the generated email-like message
#     generated_Mail = response.choices[0].text.strip()

#     # Replace placeholders with actual values
#     generated_Mail = generated_Mail.replace(customer_name, "Actual Customer's Name")
#     generated_Mail = generated_Mail.replace(your_name, "Your Actual Name")
#     generated_Mail = generated_Mail.replace(ticket_number, "Actual Ticket Number")
#     generated_Mail = generated_Mail.replace(progress_update, "Actual Progress Update")
#     generated_Mail = generated_Mail.replace(current_status, "Actual Current Status")
#     generated_Mail = generated_Mail.replace(next_steps, "Actual Next Steps")
#     generated_Mail = generated_Mail.replace(date, "Actual Date")

#     # Return the generated Email
#     return generated_Mail

# # Callback to generate SMS and Email messages
# @app.callback(
#     [
#         Output('ts-Sms-box', 'value'),
#         Output('ts-Email-functional-box', 'value'),
#         Output('tsi-loading', 'fullscreen'),
#         Output('tsg-email-failed', 'is_open'),
#         Output('tsg-email-success', 'is_open')
#     ],
#     [
...
#         State('tsi-loading', 'fullscreen')
#     ],
#     prevent_initial_call=True
# )
# def generate_messages(n_clicks, uploaded_pdf, fullscreen):
#     # Check if the callback was triggered by the submit button
#     if not n_clicks:
#         raise PreventUpdate

#     try:
#         # Your logic for generating SMS and email messages based on text_input and uploaded_pdf goes here

#         # For SMS generation
#         pdf_text = extract_text_from_pdf(uploaded_pdf)
#         trimmed_pdf_text = pdf_text[:1000]
#         # Replace placeholders with actual values for SMS
#         generated_sms = generate_sms(trimmed_pdf_text)

#         # For Email generation
#         # Replace placeholders with actual values for Email
#         generated_Mail = generate_email(trimmed_pdf_text)

#         # Simulate a loading state
#         loading = not fullscreen

#         # Simulate success of sending email
#         email_failed = False
#         email_success = not email_failed

#         return generated_sms, generated_Mail, loading, False, email_success

#     except Exception as e:
#         # Handle any exceptions and show the email failure alert
#         return "", "", False, True, False

# # ...


# # Ticket Status Insight And Functionality(Vaibhav)
# tsi_generator_layout = html.Div([
#     dbc.Navbar(children=[
#         dbc.NavItem(html.A(html.I(className="fas fa-home"), href="/", style={
#             "margin": "0px 0px 0px 20px", "font-size": "30px", "color": "white"})),
#         dbc.NavbarBrand("Ticket Status Summary", className="mx-auto",
#                         style={"text-align": "center", "font-size": "35px", "font-weight": "bold"}),
#         dbc.NavItem("Synapt-GDK", style={"margin-right": "20px", "color": "red", "font-weight": "bold"})], color="dark",
#                    dark=True),
#     dbc.Row([
#         dbc.Col([
#             html.H3("Text Paste Here:", style={'font-size': '30px'}),
#             dbc.Textarea(id='tsi-input', placeholder='Type or Paste Buisness case here...',
#                          style={'height': '150px', 'resize': 'none', 'background-color': '#444444', 'color': 'white'})
#         ], width=6),
#         dbc.Col([
#             html.H3("Upload PDF File Here:", style={'font-size': '30px'}),
...
#         ], width=5),
#         # dbc.Col([
#         #     dbc.Button([html.I(' Submit', className='fas fa-paper-plane')], color='primary', id="tsi-submit",
#         #                style={'justify-content': 'center', 'width': '120px', 'margin': '47px 0px 0px 0px'}),
#         #     dbc.Button([html.I(' Download', className='fas fa-download')], color="primary", href="", download="example.docx",
#         #                target="_blank", style={'justify-content': 'center', 'width': '120px', 'margin': '16px 0px 0px 0px'},
#         #                id="tsi-save"),
...
#         ], width=5),
#         dbc.Col([
#             html.H3("Mail Message", style={'font-size': '30px'}),
#             dbc.Textarea(id='ts-Mail-functional-box', placeholder='Nothing generated yet...',
#                          style={'height': '500px', 'resize': 'none', 'word-wrap': 'break-word',
#                                 'overflow-wrap': 'break-word', 'background-color': '#444444', 'color': 'white'},
#                          readOnly=True)
#         ], width=7),
...
# def generate_sms(text_input, pdf_contents):
#     # Replace placeholders with actual values
#     customer_name = "Actual Customer's Name"
#     your_name = "Your Actual Name"
#     your_company = "Actual Your Company"
#     ticket_number = "Actual Ticket Number"
#     progress_update = "Actual Progress Update"
#     current_status = "Actual Current Status"
#     next_steps = "Actual Next Steps"

#     sms_template = (
#         f"**SMS Message**\n\n"
#         f"**{your_name} - {your_company} Support Team**\n\n"
#         f"Hi {customer_name}! This is {your_name} from {your_company}. Quick update on your ticket {ticket_number}:\n\n"
#         f"Progress: {progress_update}\n"
#         f"Status: {current_status}\n"
#         f"Next Steps: {next_steps}\n\n"
#         "Thanks for your patience! Feel free to reply if you have questions.\n\n"
#         f"Best, {your_name}@{your_company}"
#     )

#     return sms_template

# def generate_email(text_input, pdf_contents):
#     # Replace placeholders with actual values
#     customer_name = "Actual Customer's Name"
#     your_name = "Your Actual Name"
#     your_company = "Actual Your Company"
...
#         f"I hope this message finds you well. I'm writing to provide you with an update on the status of your ticket.\n\n"
#         f"**Progress:**\n\n"
#         f"1. Resolution status: We have made significant progress in resolving the issue you reported. Our team has identified the root cause and is currently working on implementing a solution.\n\n"
#         f"2. Current Work queue: Your ticket is currently in the top priority position in our work queue. Our technicians are dedicated to resolving your issue as soon as possible.\n\n"
#         f"3. Actions Taken: To date, we have successfully investigated the problem, conducted thorough diagnostics, and implemented temporary measures to minimize the impact on your services. Our team has been working diligently to find a permanent resolution.\n\n"
#         f"4. Next Steps: We plan to provide another update on {date}. In the meantime, if you have any additional information or questions, please feel free to respond to this email. Our team is actively monitoring the ticket and will be happy to assist you.\n\n"
#         f"We sincerely appreciate your patience and understanding as we work to resolve this matter. Your satisfaction is our priority.\n\n"
#         f"Best regards,\n\n"
#         f"{your_name} - {your_company} Support Team"
#     )
...
# @app.callback(
#     [Output('ts-Sms-box', 'value'),
#      Output('ts-Mail-functional-box', 'value'),
#      Output('upload-status', 'children'),
#      Output('pdf-filename', 'children')],
#     [Input('tsi-submit', 'n_clicks')],
#     [State('tsi-input', 'value'),
#      State('upload-data', 'contents'),
#      State('upload-data', 'filename')]
# )
# def update_results(n_clicks, text_input, pdf_contents, pdf_filename):
#     if n_clicks is None:
#         raise PreventUpdate
    
#     triggered_id = ctx.triggered_id
#     is_submit_button_triggered = 'tsi-submit' in triggered_id

#     if is_submit_button_triggered:
#         # Simulate a 12-second delay
#         time.sleep(12)

#     # Check if PDF is uploaded
#     if pdf_contents:
#         upload_status = f"PDF uploaded successfully! Filename: {pdf_filename}"
#         pdf_filename_display = f"PDF Filename: {pdf_filename}"
#         # Save the uploaded PDF to a file
#         pdf_data = base64.b64decode(pdf_contents.split(",")[1])
#         with open(pdf_filename, "wb") as f:
#             f.write(pdf_data)
#         # Extract text from the PDF
#         pdf_text = extract_text_from_pdf(pdf_filename)
#     else:
#         upload_status = "No PDF uploaded."
#         pdf_filename_display = ""
#         pdf_text = ""

#     # Provide a default value for text_input if it is None
#     text_input = text_input or ""

#     # Call the functions to generate SMS and Mail messages
#     sms_result = generate_sms(text_input, pdf_text)
#     mail_result = generate_email(text_input, pdf_text)

#     return sms_result, mail_result, upload_status, pdf_filename_display
...
tsi_generator_layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            html.H3("Text Paste Here:", style={'font-size': '30px'}),
            dbc.Textarea(id='tsi-input', placeholder='Type or Paste Business case here...',
                         style={'height': '150px', 'resize': 'none', 'background-color': '#444444', 'color': 'white'})
        ], width=6),
        dbc.Col([
            html.H3("Upload PDF File Here:", style={'font-size': '30px'}),
...
def display_page(pathname):
    ...
    elif pathname == '/ticket_analysis':
        return tsi_generator_layout
    else:
...
# # Define your SMS generation function
# def generate_sms(trimmed_pdf_text):
#     # Add your SMS generation logic here
#     customer_name = "[Customer's Name]"
#     your_name = "[Your Name]"
#     your_company = "[Your Company]"  # Add this line to define your_company
...
# # Define your Email generation function
# def generate_email(trimmed_pdf_text):
#     # Add your Email generation logic here
#     customer_name = "[Customer's Name]"
#     your_name = "[Your Name]"
#     your_company = "[Your Company]"  # Add this line to define your_company
...
#     prevent_initial_call=True
# )
# def generate_messages(n_clicks, text_input, uploaded_pdf, fullscreen):
#     # Check if the callback was triggered by the submit button
#     if not n_clicks:
#         raise PreventUpdate
